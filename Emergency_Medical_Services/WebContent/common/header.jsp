<header>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a href="<%= request.getContextPath() %>/donor" class="nav-link">Donor<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a href="<%= request.getContextPath() %>/avail" class="nav-link">Book<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
